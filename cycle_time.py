...
def main():
    ...
    settings = {}
    df = pd.read_csv('Reporting/output.csv')
    ...
    settings['APIcycle_column_names'] = ['Ready to Develop','In Progress','Review','Resolved','Testing']
    ...
    settings['APIlead_column_names'] = ['Planned','Specification Review', 'ToDo', 'Ready to Develop','In Progress','Review','Resolved','Testing','Ready']
    ...
    df['RTD_days'] = df['Ready to Develop']/24
    df['InProgress_Days'] = df['In Progress']/24
    df['Review_Days'] = df['Review']/24
