import unittest
from main import jira_issue,populate_issue_obj
import pandas as pd

class TestIssue(unittest.TestCase):
    metadata = {'issueSize': 'XS', 'fixVersion': 'N/A', 'issue_key': 'API-12345', 'summary': 'Implement Something', 'issuetype': 'Engineering Task', 'implementer': 'First Name Last Name'}
    history = [{'to': 'CREATION', 'from': 'void', 'time_stamp': '2022-04-02T10:26:06.319+0300'}, {'to': 'Specification', 'from': 'New', 'time_stamp': '2022-04-08T10:31:45.398+0300'}, {'to': 'Specification Review', 'from': 'Specification', 'time_stamp': '2022-04-08T10:31:50.180+0300'}, {'to': 'Planned', 'from': 'Specification Review', 'time_stamp': '2022-04-08T10:31:54.770+0300'}, {'to': 'Specification Review', 'from': 'Planned', 'time_stamp': '2022-04-08T10:31:56.908+0300'}, {'to': 'ToDo', 'from': 'Specification Review', 'time_stamp': '2022-04-08T10:32:01.864+0300'}, {'to': 'Ready to Develop', 'from': 'ToDo', 'time_stamp': '2022-04-08T10:32:05.647+0300'}, {'to': 'In Progress', 'from': 'Ready to Develop', 'time_stamp': '2022-04-08T10:32:11.820+0300'}, {'to': 'Review', 'from': 'In Progress', 'time_stamp': '2022-04-08T12:19:30.117+0300'}, {'to': 'Ready', 'from': 'Review', 'time_stamp': '2022-04-08T12:19:35.219+0300'}]
    
    def test_create_issue(self,metadata = metadata,history = history):
        mock_issue = jira_issue(metadata,history,0,[])
